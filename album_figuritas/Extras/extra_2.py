#Modificar la generaci´on de paquetes, de forma que no haya figuritas repetidas por paquete, y no haya m´as de
#  un escudo por paquete (hay 32 escudos, es lo mismo que 32 figuritas representan a dichos escudos).
import numpy as np 
import random 
